...
import auth_aiohttp_client.models
from auth_aiohttp_client import rest
from auth_aiohttp_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(auth_aiohttp_client.models, klass)
